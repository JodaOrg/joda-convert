...
[Release 2.0](download.html) is the current latest release.
...
Available in [Maven Central](http://search.maven.org/#artifactdetails%7Corg.joda%7Cjoda-convert%7C2.0%7Cjar).
